...
namespace Unity.LEGO.Game
{
    ...
    public class GameFlowManager : MonoBehaviour
    {
        ...
        private int[] sceneNum = new int[10]; //number of scenes
        ...
        void OnGameOver(GameOverEvent evt)///////////////////////////////////////////////
        {
            if (!GameIsEnding )
            {
                ...
                if (evt.Win)
                {
                   ...
                   nextScene = Random.Range(0, sceneNum.Length);


                    m_GameOverSceneToLoad = nextScene.ToString();//m_WinScene;
